...
class FormOne extends Component{
    ...
    saveAndContinue = (e) => {
        ...
        if ((!validEmailRegex.test(values.email)) && (values.email !== '')){
        ...
        if ((values.tel.length !== 8) && (values.tel !== '')){
                ...
                <Container>
                    <Grid container spacing={3}>
                        ...
                        <Grid 
                            ...
                            {(this.state.titleRequired) ? (<span className="errMsg">Required</span>) : ('')}
                        ...
                        <Grid 
                            ...
                            <TextField 
                                ...
                                fullWidth
                                    />
                            {(this.state.fnameRequired) ? (<span className="errMsg">Required</span>) : ('')}
                        </Grid>
                        <Grid 
                            item 
                            xl={5}
                            ...
                            <TextField 
                                ...
                                fullWidth
                                    />
                            {(this.state.lnameRequired) ? (<span className="errMsg">Required</span>) : ('')}
                        </Grid>
                        <Grid 
                            item 
                            xl={6}
                            ...
                            sm={6} 
                            xs={12} >
                                <label className="datepickerLabel">Date of Birth</label>
                            <DatePicker
                                    selected={values.dob}
                        ...
                        <Grid 
                            ...
                            <TextField 
                                ...
                                fullWidth
                            />
                            {(this.state.emailRequired) ? (<span className="errMsg">Required</span>) : ('')}
                            {(this.state.emailFormat) ? (<span className="errMsg">Incorrect format</span>) : ('')}
                        </Grid>
                        <Grid 
                            item 
                            xl={6}
                            ...
                            <TextField 
                                ...
                                fullWidth
                                />
                                {(this.state.telRequired) ? (<span className="errMsg">Required</span>) : ('')}
                                {(this.state.telFormat) ? (<span className="errMsg">Must have 8 digits</span>) : ('')}
                        </Grid>
                        <Grid 
                            item 
                            align="right"
